...
const css = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  :root {
    --acid: #c8f135; --acid-dim: #8aab1f;
    --bg: #070708; --bg1: #0c0c0e; --bg2: #111114; --bg3: #18181c;
    --border: #1f1f24; --border2: #2a2a30;
    --text: #e2e2e8; --text2: #7a7a88; --text3: #3a3a44;
    --red: #ff4d4d; --yellow: #f5c542;
  ...
  return (
    <>
      ...
      <main className="main">
        ...
        {/* AI Polish banner */}
        {markdown && !aiDone && (
          <div className="ai-banner fadeUp">
